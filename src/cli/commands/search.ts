...
export function registerSearch(program: Command): void {
  program
    ...
    .description('Hybrid search the palace and display ranked results')
    .addHelpText('after', `
Details:
  Embeds the query, runs vector + keyword search, prints results with
  wing/room, source file, similarity score, and text preview.
  Scores are color-coded: green >= 0.70, yellow >= 0.55.

Examples:
  nardo search "how does scoring work"
